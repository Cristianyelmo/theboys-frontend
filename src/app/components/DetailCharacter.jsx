...
<Image src={`/DetailSelected/${characterselected[valueImage].name}_4.webp`} width={1200} height={800} className={`absolute   opacity-0  ${objectanimationserieandcomic.animation4}`}/>
<Image src={`/DetailSelected/${characterselected[valueImage].name}_3.webp`} width={1200} height={800} className={`absolute  opacity-0 ${objectanimationserieandcomic.animation3}`}/>
<Image src={`/DetailSelected/${characterselected[valueImage].name}_2.webp`} width={1200} height={800} className={`absolute  opacity-0 ${objectanimationserieandcomic.animation2}`}/>
